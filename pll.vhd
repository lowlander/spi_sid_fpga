...
-- Module  Version: 5.7
--D:\lscc\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n pll -lang vhdl -synth lse -arch xo2c00 -type pll -fin 17.734472 -fclkop 100 -fclkop_tol 10.0 -fclkos 0.9 -fclkos_tol 10.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -fb_mode 1 
...
architecture Structure of pll is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "0.985248";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "106.406832";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "17.734472";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  107, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  4, 
        ...
        PREDIVIDER_MUXB1=>  1, VCO_BYPASS_B0=> "DISABLED", CLKOS_ENABLE=> "ENABLED", 
        OUTDIVIDER_MUXA2=> "DIVA", PREDIVIDER_MUXA1=>  0, VCO_BYPASS_A0=> "DISABLED", 
        CLKOP_ENABLE=> "ENABLED", CLKOS3_DIV=>  1, CLKOS2_DIV=>  1, 
        CLKOS_DIV=>  108, CLKOP_DIV=>  5, CLKFB_DIV=>  6, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
